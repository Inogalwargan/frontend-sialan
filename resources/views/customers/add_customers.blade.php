                                ...
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <input placeholder="001S" type="text" class="form-control" name="nik">
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <input placeholder="1" type="text" class="form-control" name="point">
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <input placeholder="081xxx xxxx xxx" type="text" class="form-control" name="deposit">
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
